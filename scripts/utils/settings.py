...
brightness = -1             # Brightness level of the LED strip (-1 so that the first time we set it to 0 the code works)
...
pixel_colours = [0, 0, 0, 0]  # What all the pixels are currently set to
pixel_colours2 = [0, 0, 0, 0] # What all the pixels are currently set to
